...
workout.rename(columns={'workout': 'Workout'}, inplace=True)
# Apply to all relevant DataFrames
description.columns = description.columns.str.strip().str.lower()
precautions.columns = precautions.columns.str.strip().str.lower()
workout.columns = workout.columns.str.strip().str.lower()
medications.columns = medications.columns.str.strip().str.lower()
...
def home():
    if request.method == 'POST':
        ...
        if symptoms =="Symptoms":
            ...
            # Clean, lowercase and match valid symptoms only
            ...
            if not valid_symptoms:
                message = "No valid symptoms entered. Please check spelling and try again."
                return render_template('index.html', message=message)
